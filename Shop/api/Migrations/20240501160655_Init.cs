    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_shelf_product", x => new { x.ShelfId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_shelf_product_products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_shelf_product_shelf_ShelfId",
                        column: x => x.ShelfId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_shelf_product_ProductId",
                table: "shelf_product",
                column: "ProductId");
        }
